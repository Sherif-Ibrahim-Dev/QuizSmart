...
namespace QuizSmart.API.Migrations
{
    ...
    [Migration("20260421174947_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuestionBank", b =>
                {
                    b.Property<int>("QId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AllowedSubmissionType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuestionBank", b =>
                {
                    b.HasOne("QuizSmart.API.Models.Course", "CourseCodeNavigation")
                        .WithMany("QuestionBanks")
                        .HasForeignKey("CourseCode")
                        .HasPrincipalKey("CourseCode")
                        .HasConstraintName("FK__Question___cours__3D5E1FD2");
            ...
            modelBuilder.Entity("QuizSmart.API.Models.Exam", b =>
                {
                    b.HasOne("QuizSmart.API.Models.Course", "CourseCodeNavigation")
                        ...
                        .HasForeignKey("CourseCode")
                        .HasPrincipalKey("CourseCode")
                        .HasConstraintName("FK__Exams__course_co__403A8C7D");
            ...
            modelBuilder.Entity("QuizSmart.API.Models.ExamQuestion", b =>
                {
                    ...
                    b.HasOne("QuestionBank", "Question")
                        .WithMany("ExamQuestions")
                        .HasForeignKey("QId")
                        .IsRequired();
            ...
            modelBuilder.Entity("StudentAnswer", b =>
                {
                    ...
                    b.HasOne("QuestionBank", "QIdNavigation")
                        .WithMany("StudentAnswers")
                        .HasForeignKey("QId")
